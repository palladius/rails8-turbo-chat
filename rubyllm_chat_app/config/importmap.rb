...
# via bin/importmap pin @tailwindcss/typography
...
pin "tailwindcss/colors", to: "tailwindcss--colors.js" # @4.1.6
pin "tailwindcss/plugin", to: "tailwindcss--plugin.js" # @4.1.6
